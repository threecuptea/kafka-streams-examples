...
/**
 * Ported from https://github.com/confluentinc/examples/blob/3.2.x/kafka-streams/src/test/java/io/confluent/examples/streams/kafka/KafkaEmbedded.java
 *
 ...
 *
 * http://lampwww.epfl.ch/~michelou/scala/using-scala-from-java.html is an excellent article
 * how to call scala class/ object from java class
 *
 */
public class KafkaEmbedded {
    ...
    private Properties effectiveConfigFrom(Properties initialConfig) throws IOException {
        ...
        // Inside object KafkaConfig, val BrokerIdProp, KafkaConfig.BrokerIdProp() works in thise case.
        //However, when KafkaConfig class and its companion object have the same val or def, this would be hidden.
        //In this case, we have to KafkaConfig$.MODULE$.BrokerIdProp() signature !!!
